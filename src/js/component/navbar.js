                    ...
                    <div className={`${navCollapseClass} navbar-collapse`} id="navbarResponsive">
                        <ul className="navbar-nav ms-auto py-4 py-lg-0">
                            ...
                            <li className="nav-item">
                                ...
                                <a className="btn px-lg-2 py-3 py-lg-4" id="buttonAula" target='_blank' onClick={handleLogoClick} rel='noopener noreferrer' href="https://138728.demos.evolcampus.com">Aula Virtual</a>
                            </li>
                        </ul>
                    </div>
                </div>
